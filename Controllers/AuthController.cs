...
namespace DenizenPastingWebsite.Controllers
{
    public class AuthController : PasteController
    {
        ...
        public IActionResult Login()
        {
            ...
            Response.Cookies.Append("discord_auth_state_key", state, new CookieOptions() { HttpOnly = true, IsEssential = true, SameSite = SameSiteMode.Strict, MaxAge = TimeSpan.FromMinutes(15) });
